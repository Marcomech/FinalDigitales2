...
void SystemClock_Config(void)
{
  //Estas lineas inicializan las estructuras que usa el Cube, en principio nosotros no las necesitariamos
  ...
  // RCC-> |= (1 << 16); //Habilita el HSE oscillator

  RCC_OscInitStruct.HSEPredivValue = RCC_HSE_PREDIV_DIV1;
  //Creo que nuestra placa no tiene para dividir el valor del HSE asi que esta linea no iria
